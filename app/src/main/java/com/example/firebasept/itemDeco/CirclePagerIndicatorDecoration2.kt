...
class CirclePagerIndicatorDecoration2 : ItemDecoration() {
    ...
    override fun onDrawOver(
        ...
        val indicatorStartX = (parent.width - indicatorTotalWidth) / 1f

        // center vertically in the allotted space
        val indicatorPosY = parent.height - (mIndicatorHeight+392* DP) / 2f
...
//        drawHighlights(c, indicatorStartX, indicatorPosY, activePosition % itemCount, progress);
        val i:Int = if(activePosition < 2){
            0
        }
        else if(activePosition < 5) 1
        else 2
