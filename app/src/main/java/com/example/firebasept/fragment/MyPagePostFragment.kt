...
import com.example.firebasept.recyclerView.MyPagePostViewAdapter
...
import kotlinx.android.synthetic.main.fragment_my_page_post.*

internal class MyPagePostFragment:Fragment() {
    ...
    lateinit var adapter:MyPagePostViewAdapter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_my_page_post, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = MyPagePostViewAdapter(viewModel) // 이부분이 중요 밑에 갱신까지 이어짐, 아근데 이부분 자세히 공부해야할듯 발표끝나고 보자
