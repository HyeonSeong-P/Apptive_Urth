...
import com.byphs.firebasept.recyclerView.ProductViewAdapter
...
internal class ProductFragment:Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(viewModel.productTagCategory.value != null){
            var clickTagNum = 0
            for((i, tagString) in categoryList.withIndex()){
                if(viewModel.productTagCategory.value!!.containsKey(tagString)){
