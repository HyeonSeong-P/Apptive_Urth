...
import com.byphs.firebasept.recyclerView.WritePhotoViewAdapter
import com.byphs.firebasept.recyclerView.WritePostProductViewAdapter
...
/*            adapter1.notifyDataSetChanged()
        ...
        gallery_btn.setOnClickListener {
            ...
            startActivityForResult(Intent.createChooser(intent,"사진은 5장까지 업로드 가능합니다."),  100)
    ...
    fun setButton(){
        back_btn_write_post.setOnClickListener {
            findNavController().navigateUp()
        }
