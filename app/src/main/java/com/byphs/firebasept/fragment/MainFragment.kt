...
internal class MainFragment:Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        email_sign_in_button.setBackgroundResource(R.drawable.unclickable_button_design)
        ...
        email_edit_text.addTextChangedListener(object: TextWatcher {
            ...
            override fun afterTextChanged(p0: Editable?) {
                if(email_edit_text.text.toString() == "" || password_edit_text.text.toString() == ""){
                    email_sign_in_button.setBackgroundResource(R.drawable.unclickable_button_design)
                    email_sign_in_button.isEnabled= false
                }
                else{
                    email_sign_in_button.setBackgroundResource(R.drawable.button_design)
