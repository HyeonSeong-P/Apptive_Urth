...
import com.byphs.firebasept.itemDeco.ProfilePostItemDeco
import com.byphs.firebasept.recyclerView.UserPagePostViewAdapter
...
internal class UserFragment:Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        user_page_back_btn.setOnClickListener {
